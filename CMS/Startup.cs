...
namespace CMS
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("DbConnection"), x => x.MigrationsAssembly("CMS"));
            });
            services.AddDbContext<DataProtectionkeysContext>(options =>
            {
                options.UseSqlServer(Configuration.GetConnectionString("DbProtectionConnection"), x => x.MigrationsAssembly("CMS"));
            });
            ...
            var identityDefaultsOptionsConfiguration = Configuration.GetSection("IdentityDefaultOptions");
            services.Configure<IdentityDefaultOptions>(identityDefaultsOptionsConfiguration);
            var identityDefaultOtions = identityDefaultsOptionsConfiguration.Get<IdentityDefaultOptions>();
